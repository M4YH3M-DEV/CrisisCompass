...
def allocate_resources(resource_data):
    ...
    total_resources = {
        ...
        'rescuePersonnel': sum(dept['rescuePersonnelHave'] for dept in departments.values())
    }
    ...
    gaps = {
        ...
        'medical': max(0, resource_data['medicalRequired'] - resource_data['medicalHave']),
        'shelter': max(0, resource_data['shelterRequired'] - resource_data['shelterHave']),
        'blankets': max(0, resource_data['blanketsRequired'] - resource_data['blanketsHave']),
        'rescuePersonnel': max(0, resource_data['rescuePersonnelRequired'] - resource_data['rescuePersonnelHave'])
    }
